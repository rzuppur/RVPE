import type { DOMOutputSpec, ParseRule, Schema } from "prosemirror-model";
...
export default class Link extends BaseMark {
  ...
  get schema() {
    return {
      ...
      toDOM: (node) => {
        return ["a", { href: node.attrs.href, rel: "noopener noreferrer nofollow", target: "_blank" }, 0] as DOMOutputSpec;
      },
    }
  }
